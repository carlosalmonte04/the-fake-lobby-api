"""
Django settings for python_thefakelobby_api project.
...
ROOT_URLCONF = 'python_thefakelobby_api.urls'
...
WSGI_APPLICATION = 'python_thefakelobby_api.wsgi.application'
